  ...
  return (
    <>
      ...
      <div className="gallery-band-4">
        <img src={`${BLOB}/25-tennis-at-curtain-bluff.webp`} alt="Championship tennis courts at Curtain Bluff" />
        <img src={`${BLOB}/curtain-bluff-tennis-class.webp`} alt="Tennis coaching clinic at Curtain Bluff" />
        <img src={`${BLOB}/pt-ground-sports-bg.webp`} alt="Ground sports facilities at Curtain Bluff" />
        <img src={`${BLOB}/curtain-bluff-gym.webp`} alt="Fitness centre and gym at Curtain Bluff" />
      </div>
