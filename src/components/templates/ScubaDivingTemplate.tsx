  ...
  return (
    <>
      ...
      <div className="gallery-band-4">
        <img src={`${BLOB}/activities-8.webp`} alt="Scuba diver exploring Cades Reef near Curtain Bluff" />
        <img src={`${BLOB}/activities-10.webp`} alt="Colourful marine life at Cades Reef" />
        <img src={`${BLOB}/pt-padi-bg.webp`} alt="Underwater diving adventure at Curtain Bluff" />
        <img src={`${BLOB}/curtain-bluff-diving.webp`} alt="Dive boat departing from Curtain Bluff beach" />
      </div>
